  ...
  return (
    <section className="pt-24 pb-16">
      ...
      <div className="flex gap-4 text-sm">
        <a href="https://github.com/AlvarodOrs" target="_blank" rel="noopener noreferrer"
          className="text-neutral-500 hover:text-neutral-200 transition-colors">
          github ↗
        </a>
        <a href="https://linkedin.com/in/alvaro-dors" target="_blank" rel="noopener noreferrer"
          className="text-neutral-500 hover:text-neutral-200 transition-colors">
          linkedin ↗
        </a>
